...
% define well-fit: noad-tg, x% bootstraps within 22.5 deg of all-trials-included fit
...
percentile_threshold = 0.75; percentile_idx = percentile_threshold * nrun;
ori_perc = ori_distance(:, percentile_idx);
well_fit_cell = ori_perc < (180 / nori);

if save_flag
    save fit_bootstrap_75perc.mat fit_param_runs ori_pref_runs well_fit_cell ori_perc; 
end
