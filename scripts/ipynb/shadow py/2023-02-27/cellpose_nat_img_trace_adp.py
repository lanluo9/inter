...
stim2_time = np.arange((9.5-2)*3, (9.5-2)*3 + 2, 0.01)
trace_min = np.amin(trace_by_trial[10:20,1,:])
...
for i in np.arange(10,20):
    plt.plot(trace_by_trial[i,1,:], alpha=0.7)
...
plt.text(1, trace_min + 0.02, 'S1', ha='center', va='bottom', fontsize=16) # text annotation for stim-on time
plt.text((9.5-2)*3 + 1, trace_min + 0.02, 'S2', ha='center', va='bottom', fontsize=16);
