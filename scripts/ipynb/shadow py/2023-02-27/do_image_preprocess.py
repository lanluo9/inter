...
input_path = r'\\duhs-user-nc1.dhe.duke.edu\dusom_glickfeldlab\All_Staff\home\lan\Mwork\stimulus_image\McGill\Shadows_high_reso'.replace("\\", "/")
save_path = r'\\duhs-user-nc1.dhe.duke.edu\dusom_glickfeldlab\All_Staff\home\lan\Mwork\stimulus_image\McGill\cut\52'.replace('\\', '/')
...
ft_filtered[ft_distance < 0.02*distance_range] = 1e-8
ft_filtered[ft_distance > 0.05*distance_range] = 1e-8 # band pass filter
