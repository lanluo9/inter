function bwOut = imCellEditInteractiveLG_LL(fovImg, bwCell, zoomToAxis, cellRadius)
...
% draw initial figure
figH = figure;
imH = subDrawShaded(-1*fovImg, bwCell, zoomToAxis);
axH = get(imH, 'Parent');
    ...
    if isnan(X)
        ...
        switch key
          ...
          case 'z' 
            ...
            subDrawShaded(-1*fovImg, bwCurr, zoomToAxis);
