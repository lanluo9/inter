function [fit_param, ori_pref] = fit_tuning(dfof_tg, save_flag)
...
for icond = 1:ncond
    ...
    ori_pref_cond = rad2deg(fit_param(:, 5, icond));
    ori_pref_cond(ori_pref_cond < 0) = ori_pref_cond(ori_pref_cond < 0) + 180; ori_pref_cond(ori_pref_cond > 180) = ori_pref_cond(ori_pref_cond > 180) - 180;
    ori_pref(:, icond) = ori_pref_cond;
end

if save_flag; save fit_tuning_isi3.mat fit_param ori_pref; end
